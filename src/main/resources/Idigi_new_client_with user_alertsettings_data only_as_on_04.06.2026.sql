CREATE DATABASE  IF NOT EXISTS `idigitest` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `idigitest`;
...
CREATE TABLE `alertsettings` (
  ...
  `MaximumNumberOfRegistrations` int DEFAULT NULL,
...
CREATE TABLE `balancelog` (
  ...
  `SyncTime` varchar(100) DEFAULT NULL,
  `SyncInterval` int DEFAULT '0',
  `PayType` varchar(100) NOT NULL,
  `BatteryVoltage` decimal(10,2) NOT NULL,
  `ValveConfiguration` tinyint DEFAULT '0',
  `ValveStatus` tinyint DEFAULT '0',
  `Balance` decimal(10,2) NOT NULL,
  `TariffID` int DEFAULT '0',
  `Tariff` decimal(10,2) DEFAULT '0.00',
  `EmergencyCredit` decimal(10,2) NOT NULL,
  `Minutes` bigint DEFAULT '0',
  `Reading` decimal(10,2) NOT NULL,
  `DoorOpenTamper` tinyint DEFAULT '0',
  `MagneticTamper` tinyint DEFAULT '0',
  `Vacation` tinyint DEFAULT '0',
  `RTCFault` tinyint DEFAULT '0',
  `NFCTamper` tinyint DEFAULT '0',
  `LowBattery` tinyint DEFAULT '0',
  `LowBalance` tinyint DEFAULT '0',
  `Source` varchar(100) DEFAULT NULL,
  `ID` bigint DEFAULT NULL,
  `LogDate` datetime NOT NULL,
  PRIMARY KEY (`ReadingID`)
) ENGINE=InnoDB AUTO_INCREMENT=16595 DEFAULT CHARSET=latin1;
/*!40101 SET character_set_client = @saved_cs_client */;
...
CREATE TABLE `customerdeletemeter` (
  ...
  `DefaultReading` decimal(10,2) NOT NULL,
...
CREATE TABLE `customerdetails` (
  ...
  `DeviceInstanceID` varchar(100) DEFAULT NULL,
  `FirstName` varchar(50) NOT NULL,
  `LastName` varchar(50) NOT NULL,
  `Email` varchar(100) NOT NULL,
  `MobileNumber` varchar(10) NOT NULL,
...
DROP TABLE IF EXISTS `energylog`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `energylog` (
  ...
  `PublishedAt` varchar(1000) DEFAULT NULL,
  `count` bigint NOT NULL,
  `LogDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ModifiedDate` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`ReadingID`),
  UNIQUE KEY `ReadingID_UNIQUE` (`ReadingID`)
) ENGINE=InnoDB AUTO_INCREMENT=5680 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_0900_ai_ci;
/*!40101 SET character_set_client = @saved_cs_client */;
...
--
-- Table structure for table `meterlocation`
--

DROP TABLE IF EXISTS `meterlocation`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `meterlocation` (
  `MeterLocationID` int NOT NULL AUTO_INCREMENT,
  `MeterLocationName` varchar(100) NOT NULL,
  `BlockID` int NOT NULL,
  `CommunityID` int NOT NULL,
  `CreatedDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  `ModifiedDate` datetime NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`MeterLocationID`),
  UNIQUE KEY `LocationID_UNIQUE` (`MeterLocationID`)
...
CREATE TABLE `topup` (
  ...
  `EmergencyCredit` decimal(10,0) NOT NULL,
...
INSERT INTO `alertsettings` VALUES ('1', '4320', '330', '51', '50', '20', '10', '2nd of everymonth', '0', NULL, NULL, '500', 'All the water meter readings are shown in liters', 'k@gmail.com', 'Sribabu@123', sysdate(), sysdate());

INSERT INTO `userrole` VALUES ('1', 'Super Admin');
INSERT INTO `userrole` VALUES ('2', 'Admin');
INSERT INTO `userrole` VALUES ('3', 'User');
INSERT INTO `userrole` VALUES ('4', 'SuperAdminSupervisor');
INSERT INTO `userrole` VALUES ('5', 'AdminSupervisor');
INSERT INTO `userrole` VALUES ('6', 'Support');
