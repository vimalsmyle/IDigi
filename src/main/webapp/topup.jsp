            ...
            <div class="card">
                ...
                <form id="topupDetails">
                        ...
                        <div class="col-md-4">
                          ...
                          <div class="col-md-4">
                            <div class="group form-group">
                              ...
                              <select class="form-control form-control-sm select2" id="selectHouseBasedonBlock" name="selectHouseBasedonBlock" onchange="showAllMetersDetails(this.value);">
                              </select>
                            </div>
                          </div>
                          ...
                          <div class="col-md-4">
                            ...
                            <div class="group form-group">
                              <label class="bmd-label-floating select-label">Select CRN<sup class="imp">*</sup></label>
                              <select class="form-control form-control-sm" id="selectHouseBasedonBlock" name="selectHouseBasedonBlock" onchange="showAllMetersDetails(this.value);">
                              </select>
                            </div>
                          </div>
                    ...
                    <div class="row">
                        ...
                        <button id="topup" class="btn btn-secondary submit-button btn-raised" disabled>Submit<div class="ripple-container"></div></button>
                        <button type="button" class="btn btn-secondary btn-raised resetFilter" id="resetFilter">Reset</button>
                        </div>
