					...
					$("#userconsumption")
							.click(
									function() {
										...
										}else if($("#reportType").val()=="Tabular" || $("#reportType").val()=="solar"){
										...
										$
												.ajax({
													...
													url : "./userconsumptionreports/"+typeReport.trim(),
													data : JSON
															.stringify(data1),
													dataType : "JSON",
													...
													success : function(d) {
														...
														}else if(typeReport.trim()=="Tabular"){
														$("#theadBody").append("<tr><th>Customer Unique ID</th><th>MIU ID</th><th>Reading</th>" +
																"<th>Battery</th><th>Consumption</th><th>Balance</th><th>Tariff</th><th>Alarm Credit</th>" +
																"<th>Emergency Credit</th><th>Date Time</th></tr>")
														 ...
														 $(".totalCount")
															...
															$("#theadBody").append("<tr><th>Customer Unique ID</th><th>Relay Status</th><th>R Status</th><th>Y Status</th>" +
																"<th>B Status</th><th>Date Time</th></tr>")
														 ...
														 $("div.headname").html('<h3>User Consumptions</h3>');
														 var template = `<b>CAN:</b><span>`+d.data[0].customerUniqueID+`</span>`;
														 $(".totalCount")
															.html(template);
