...
<body class="main-sidebar-show">
			...
			<div class="inner-body custom-scrollbar-js" id="content-5">
				<div class="row custom-scrollbar-css">
					<div class="col-md-12">
						<div class="row">
							<div class="col-md-12">
								<a class="text-dark" href="home.jsp">Home</a> <span>/</span> <span
									class="activeurl">Solar Details</span>
							</div>
						</div>
						...
						<input type="hidden" value='<%=customerUniqueID%>' id="customerUniqueID">
	...
	<script src="js/solarDashboard.js"></script>
